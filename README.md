...
- 🚀 [Quick Start Guide](./QUICK_START.md) — подробное руководство по началу работы.
- 📖 [План развития](./DEVELOPMENT_PLAN.md) — дорожная карта проекта.
- 📊 [Evaluation Examples](./eval/EXAMPLES.md) — примеры работы системы оценки.
- 🧪 [Benchmarks](./benchmarks/README.md) — результаты тестирования производительности.
