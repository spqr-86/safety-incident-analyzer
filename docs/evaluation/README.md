...
## 🚀 Быстрый запуск оценки

```bash
# Запустить полную оценку на первых 5 вопросах
...
| **Faithfulness** | Отсутствие галлюцинаций (основан ли ответ на контексте) | > 0.90 |
| **Answer Relevance** | Насколько ответ соответствует заданному вопросу | > 0.85 |
| **Citation Quality** | Наличие и корректность ссылок `[cite: X]` | > 0.90 |
