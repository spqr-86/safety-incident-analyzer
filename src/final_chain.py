...
# --- Ключевые импорты для Гибридного Поиска ---
...
def create_final_hybrid_chain():
    """
    Создает самую продвинутую RAG-цепочку, используя гибридный поиск
    ...
    vector_store = load_vector_store(docs) # Передаем документы для консистентности
